...
public class LoginPage extends PageObject {
    ...
    By TXT_FIELD_PASSWORD = By.xpath("//input[contains(@name,'new_password')]");
    By TXT_FIELD_CONFIRM_PASSWORD = By.xpath("@FindBy(xpath = \"//input[contains(@name,'confirmed_password')]\")");
    By TXT_SPAN_HOME_PAGE = By.xpath("//strong[@class='d3c6350bdd b08a362a8a'][contains(.,'¡Ya estás en Genius! Has desbloqueado el Nivel 1')]");
}
